...
export const TEACHER_FORM_TEXT = {
    ...
    gradeGroup: { label: 'Grade Group', placeholder: 'Select grade group' },
    grade: { label: 'Grade', placeholder: 'Select grade', disabledPlaceholder: 'Select grade group first' },
    subject: { label: 'Subject', placeholder: 'Select subject' },
    region: { label: 'Region', placeholder: 'Select region' },
    schoolName: { label: 'School', placeholder: 'Select school', disabledPlaceholder: 'Select region first' },
    udisecode: { label: 'UDISE Code', placeholder: 'Auto-filled from school' },
    cancelButton: 'Cancel',
...
export const TEACHER_VALIDATION = {
    ...
    regionId: { requiredMessage: 'Region is required' },
    schoolId: { requiredMessage: 'School is required' },
